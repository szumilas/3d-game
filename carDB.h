...
static std::map<CarBrand, CarDetails> carDB
{
	...
	{ CarBrand::LamborghiniHuracan, { "Data/Cars/lamborghini_huracan/", Textures::lamborghini_huracan, Sounds::engine, -1.45f, 1.27f, 0.85f, 1422.0f, 325.0f, 449.0f, 3.54f, std::vector<float>{0.0f, 3.91f, 2.44f, 1.81f, 1.46f, 1.18f, 0.97f, 0.84f} } },
