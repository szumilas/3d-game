...
static std::map<CarBrand, CarDetails> carDB
{
	...
	{ CarBrand::SuzukiVitara,{ "Data/Cars/suzuki_vitara.obj", Textures::suzuki_vitara, 1270.0f, 180.0f, 88.0f, 3.61f, std::vector<float>{0.0f, 3.54f, 2.05f, 1.23f, 0.88f, 0.70f, 0.59f} } },
